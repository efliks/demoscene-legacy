...
It seems that a 386DX with a VGA video card is required just to start. 
I did the original development on a Pentium 133 Mhz system, but I have never 
run these effects on anything slower.
