...
BYTE FontData[256 * 8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
0x18, 0x18, 0x18, 0x18, 0x08, 
...
void PutString(char *str, int x, int y, BYTE col, int chcol) {
	int i, j, k = 0;
	char c, ccol;
	BYTE *ptr = FrameBuffer + x + (y << 6) + (y << 8), *oldptr, *f, t;
